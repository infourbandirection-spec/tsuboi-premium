        ...
        <div class="max-w-6xl mx-auto">
          ...
          <div class="bg-white rounded-lg shadow-2xl p-8 mb-8">
            <div class="text-center mb-6">
              ...
              <p class="text-xl text-green-800 mb-2">
                坪井繁栄会プレミアム商品券応募抽選
              </p>
            ...
            <div class="bg-green-100 rounded-lg p-6 border-2 border-green-600">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
                <div>
                  <p class="text-sm text-green-800 mb-1">合計冊数</p>
                  <p class="text-3xl font-bold text-green-900">
                    ${this.winners.reduce((sum, w) => sum + w.quantity, 0)} 冊
                  </p>
                </div>
                <div>
                  <p class="text-sm text-green-800 mb-1">抽選日</p>
          ...
          <div class="bg-white rounded-lg shadow-xl p-6 mb-8">
            <h2 class="text-2xl font-bold text-green-900 mb-4">
              <i class="fas fa-filter text-green-700 mr-2"></i>
              当選者一覧フィルター
            </h2>
            <input 
              type="text" 
              ...
              class="w-full px-4 py-3 border-2 border-green-600 rounded-lg focus:outline-none focus:border-green-800"
          ...
          <div class="bg-white rounded-lg shadow-xl p-6">
            ...
            ${filteredWinners.length === 0 ? `
              <div class="text-center py-12 text-green-700">
            ...
            ` : `
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ${filteredWinners.map((winner, index) => `
                  <div class="bg-white rounded-lg p-4 border-2 border-green-600 hover:shadow-lg transition">
                    <div class="flex items-start justify-between mb-2">
                      <span class="inline-block px-3 py-1 bg-green-800 text-white rounded text-sm font-bold">
                        No.${index + 1}
                      </span>
                    </div>
                    <p class="text-sm text-green-800 mb-1">応募ID</p>
                    <p class="text-lg font-bold text-green-900 break-all mb-3">
                      ${this.escapeHtml(winner.reservation_id)}
                    </p>
                    <div class="flex justify-between items-center pt-2 border-t border-green-300">
                      <span class="text-sm text-green-800">冊数</span>
                      <span class="text-lg font-bold text-green-900">${winner.quantity} 冊</span>
                    </div>
                  </div>
                `).join('')}
              </div>
          ...
          <div class="bg-white rounded-lg shadow-xl p-6 mt-8">
            ...
            <ul class="space-y-3 text-green-800">
              ...
              <li class="flex items-start">
                <i class="fas fa-id-card text-green-700 mt-1 mr-3"></i>
              ...
              <li class="flex items-start">
                <i class="fas fa-map-marker-alt text-green-700 mt-1 mr-3"></i>
                <span>購入場所: <strong>一畳屋ショールーム</strong>（熊本県熊本市中央区坪井5丁目2-27）</span>
              </li>
              <li class="flex items-start">
                <i class="fas fa-exclamation-triangle text-green-700 mt-1 mr-3"></i>
          ...
          <div class="mt-8 flex gap-4 justify-center">
            <a href="/" class="px-8 py-4 bg-green-800 text-white rounded-lg hover:bg-green-900 font-bold shadow-lg transition">
              <i class="fas fa-home mr-2"></i>
              トップページ
            </a>
            <a href="/search" class="px-8 py-4 bg-green-700 text-white rounded-lg hover:bg-green-800 font-bold shadow-lg transition">
    ...
    return `
      <div class="min-h-screen bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center p-4">
        <div class="bg-white rounded-lg shadow-2xl p-12 max-w-2xl text-center">
          <i class="fas fa-clock text-7xl text-green-500 mb-6"></i>
          <h1 class="text-3xl font-bold text-green-900 mb-4">
            抽選はまだ実行されていません
          </h1>
          <p class="text-green-800 mb-8">
          ...
          <div class="flex gap-4 justify-center">
            ...
            <button onclick="location.reload()" class="px-8 py-4 bg-green-700 text-white rounded-lg hover:bg-green-800 font-bold shadow-lg transition">
