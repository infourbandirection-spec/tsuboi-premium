...
function getPhase1ReservationEmail(): string {
  return `
<!DOCTYPE html>
<html>
<head>
...
function getPhase2ReservationEmail(): string {
  return `
<!DOCTYPE html>
<html>
<head>
...
// 当選メールテンプレート
function getWinnerEmail(): string {
  return `
<!DOCTYPE html>
<html>
<head>
